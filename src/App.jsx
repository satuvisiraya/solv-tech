  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden scroll-smooth">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href="https://wa.me/+62882003843947?text=Halo%20SolvTech,%20saya%20tertarik%20dengan%20layanan%20Anda"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative bg-gradient-to-r from-green-500 to-green-600 text-white p-4 rounded-full shadow-2xl shadow-green-500/25 hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:scale-110 animate-bounce-gentle"
        >
